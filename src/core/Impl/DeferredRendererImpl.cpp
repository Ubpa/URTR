...
DeferredRenderer::Impl::Impl()
	: tex0{ new gl::Texture2D },
	depth{ new gl::RenderBuffer }
{
	tex0->SetWrapFilter(gl::WrapMode::ClampToEdge, gl::WrapMode::ClampToEdge, gl::MinFilter::Nearest, gl::MagFilter::Nearest);
...
void DeferredRenderer::Impl::ResizeBuffer(size_t width, size_t height) {
	...
	tex0->SetImage(0, gl::PixelDataInternalFormat::Rgba32F, width, height, gl::PixelDataFormat::Rgba, gl::PixelDataType::Float, nullptr);
...
void DeferredRenderer::Impl::RenderImpl(Scene* scene, SObj* camObj, size_t width, size_t height) {
	...
	screenProgram->Active(0, gb.GetTex2D(gl::FramebufferAttachment::ColorAttachment0));
