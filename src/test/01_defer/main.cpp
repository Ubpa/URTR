...
int main() {
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Ubpa@2020 : test - 01 - defer", NULL, NULL);
    if (window == NULL)
    {
	...
	auto [sobj1, tsfm1, geo1, mat1] = scene.CreateSObj<Cmpt::Geometry, Cmpt::Material>("sobj1");
	auto [sobj2, tsfm2, geo2, mat2] = scene.CreateSObj<Cmpt::Geometry, Cmpt::Material>("sobj2");
	auto [sobj3, tsfm3, geo3, mat3] = scene.CreateSObj<Cmpt::Geometry, Cmpt::Material>("sobj3");
