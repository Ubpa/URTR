...
int main() {
	...
	auto [sobj3, geo3, mat3, r] = scene.CreateSObj<Cmpt::Geometry, Cmpt::Material, Rotater>("sobj3");
    auto [sobj4, light4] = scene.CreateSObj<Cmpt::Light>("sobj4");
    auto [sobj5, env] = scene.CreateSObj<Cmpt::Light>("sobj5");
    auto [sobj6, light6, geo6] = scene.CreateSObj<Cmpt::Light, Cmpt::Geometry>("sobj6");
